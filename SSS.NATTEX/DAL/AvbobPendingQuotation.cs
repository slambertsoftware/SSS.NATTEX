...
{
    public class AvbobPendingQuotation
    {
        [Key]
        ...
        public virtual ICollection<AvbobPendingQuotationDocument> AvbobPendingQuotationDocuments { get; set; }

        public virtual ICollection<AvbobPendingQuotationMember> AvbobPendingQuotationMembers { get; set; }
