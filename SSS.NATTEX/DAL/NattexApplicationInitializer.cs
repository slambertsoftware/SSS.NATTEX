    ...
    public class NattexApplicationInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<NattexApplicationContext>
    {
        protected override void Seed(NattexApplicationContext context)
        {
            ...
            var users = new List<ApplicationUser>
            {
                ...
                new ApplicationUser {ApplicationRoleID = 3, UserName = "user", FirstName = "Anna", Password="password", LastName="Office", Email="nattexfuneralscheme@gmail.com",
                    IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1},
            };
            ...
            var avbobAgeGroups = new List<AvbobAgeGroup>
            {

                new AvbobAgeGroup {AgeGroup = "0 To 64 Years", Description = "Members up to age of 64 years", IsActive = true, CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobAgeGroup {AgeGroup = "65 To 70 Years", Description = "Members from the age of 64 years up to age of 70 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobAgeGroup {AgeGroup = "75 To 84 Years", Description = "Members from the age of 75 years up to age of 84 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobAgeGroup {AgeGroup = "85 Years and older", Description = "Members from age 85 years and older", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobAgeGroup {AgeGroup = "0 To 18 Years", Description = "Extended children up to 18 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1}
            };

            avbobAgeGroups.ForEach(avbobAgeGroup => context.AvbobAgeGroups.Add(avbobAgeGroup));
            context.SaveChanges();

            var avbobPlans = new List<AvbobPlan>
            {
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan A", PlanDescription = "Plan A - for members up to the age of 64 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan B", PlanDescription = "Plan B - for members up to the age of 64 years", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan C", PlanDescription = "Plan C - for members up to the age of 64 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan D", PlanDescription = "Plan D - for members up to the age of 64 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},

                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan E", PlanDescription = "Plan E - for members up to the age of 64 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan F", PlanDescription = "Plan F - for members up to the age of 64 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan G", PlanDescription = "Plan G - for members up to the age of 64 years", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 1, PlanName = "Plan H", PlanDescription = "Plan H - for members up to the age of 64 years", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},

                new AvbobPlan {AvbobAgeGroupID = 2, PlanName = "Plan I", PlanDescription = "Plan I - for members from the age of 64 years up to the age of 74 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID =2, PlanName = "Plan J", PlanDescription = "Plan J - for members from the age of 64 years up to the age of 74 years", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 2,PlanName = "Plan K", PlanDescription = "Plan K - for members from the age of 64 years up to the age of 74 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()),CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 2, PlanName = "Plan L",PlanDescription = "Plan L - for members from the age of 64 years up to the age of 74 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},

                new AvbobPlan {AvbobAgeGroupID = 3, PlanName = "Plan M", PlanDescription = "Plan M - for members from the age of 75 years up to the age of 84 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID =3, PlanName = "Plan N", PlanDescription = "Plan N - for members from the age of 75 years up to the age of 84 years", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 3,PlanName = "Plan O", PlanDescription = "Plan O - for members from the age of 75 years up to the age of 84 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()),CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 3, PlanName = "Plan P",PlanDescription = "Plan P - for members from the age of 75 years up to the age of 84 years", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},

                new AvbobPlan {AvbobAgeGroupID = 4, PlanName = "Plan Q", PlanDescription = "Plan Q - for members from the age of 85 years and older", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 4, PlanName = "Plan R", PlanDescription = "Plan R - for members from the age of 85 years and older", IsActive = true,
                    CreateDate =  DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 4,PlanName = "Plan S", PlanDescription = "Plan S - for members from the age of 85 years and older", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()),CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 4, PlanName = "Plan T",PlanDescription = "Plan T - for members from the age of 85 years and older", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},

                new AvbobPlan {AvbobAgeGroupID = 5,PlanName = "Extended Cover 1", PlanDescription = "Extended Cover 1", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()),CreateUserID = 1},
                new AvbobPlan {AvbobAgeGroupID = 5, PlanName = "Extended Cover 2",PlanDescription = "Extended Cover 2", IsActive = true,
                    CreateDate = DateTime.Parse(DateTime.Today.ToString()), CreateUserID = 1},
            };

            avbobPlans.ForEach(avbobPlan => context.AvbobPlans.Add(avbobPlan));
            context.SaveChanges();

            var avbobPremiums = new List<AvbobPolicyPremium>
            {
                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 1, MemberCover = 10000M, SpouseCover = 10000M, Child14To21YearsCover=10000M, Child6To13YearsCover=5000M, Child1To5YearsCover=3500M, ChildStillBornTo11MonthsCover=2500M, StartAge=0, EndAge = 64, MonthlyMemberPremium=17.96M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=4.04M, TotalMonthlyMemberPremium=22.00M, CompanyMemberPremium=35.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 2, MemberCover = 15000M, SpouseCover = 15000M, Child14To21YearsCover=10000M, Child6To13YearsCover=5000M, Child1To5YearsCover=3500M, ChildStillBornTo11MonthsCover=2500M, StartAge=0, EndAge = 64, MonthlyMemberPremium=24.43M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=5.72M, TotalMonthlyMemberPremium=31.15M, CompanyMemberPremium=40.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 3, MemberCover = 20000M, SpouseCover = 20000M, Child14To21YearsCover=10000M, Child6To13YearsCover=5000M, Child1To5YearsCover=3500M, ChildStillBornTo11MonthsCover=2500M, StartAge=0, EndAge = 64, MonthlyMemberPremium=32.90M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=7.40M, TotalMonthlyMemberPremium=40.30M, CompanyMemberPremium=45.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 4, MemberCover = 30000M, SpouseCover = 30000M, Child14To21YearsCover=20000M, Child6To13YearsCover=10000M, Child1To5YearsCover=5000M, ChildStillBornTo11MonthsCover=3500M, StartAge=0, EndAge = 64, MonthlyMemberPremium=50.68M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=11.40M, TotalMonthlyMemberPremium=62.08M, CompanyMemberPremium=65.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },


                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 5, MemberCover = 10000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M,  StartAge=0, EndAge = 64, MonthlyMemberPremium=7.47M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=1.68M, TotalMonthlyMemberPremium=9.15M, CompanyMemberPremium=20.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 6, MemberCover = 15000M, SpouseCover = 0M,  Child14To21YearsCover=0M, Child6To13YearsCover=0M,  Child1To5YearsCover=0M,  ChildStillBornTo11MonthsCover=0M,  StartAge=0, EndAge = 64, MonthlyMemberPremium=11.20M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=2.52M, TotalMonthlyMemberPremium=13.72M, CompanyMemberPremium=22.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 7, MemberCover = 20000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M, StartAge=0, EndAge = 64, MonthlyMemberPremium=14.93M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=3.35M, TotalMonthlyMemberPremium=18.28M, CompanyMemberPremium=25.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 1, AvbobPlanID = 8, MemberCover = 30000M, SpouseCover = 0M,  Child14To21YearsCover=0M,  Child6To13YearsCover=0M, Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=3500M, StartAge=0, EndAge = 64, MonthlyMemberPremium=22.40M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=5.04M, TotalMonthlyMemberPremium=27.44M, CompanyMemberPremium=30.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },


                new AvbobPolicyPremium {AvbobAgeGroupID = 2, AvbobPlanID = 9, MemberCover = 10000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M,  StartAge=65, EndAge = 74, MonthlyMemberPremium=27.96M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=6.29M, TotalMonthlyMemberPremium=34.25M, CompanyMemberPremium=40.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 2, AvbobPlanID = 10, MemberCover = 15000M, SpouseCover = 0M,  Child14To21YearsCover=0M, Child6To13YearsCover=0M,  Child1To5YearsCover=0M,  ChildStillBornTo11MonthsCover=0M,  StartAge=65, EndAge = 74, MonthlyMemberPremium=41.94M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=9.43M, TotalMonthlyMemberPremium=51.37M, CompanyMemberPremium=52.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 2, AvbobPlanID = 11, MemberCover = 20000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M, StartAge=65, EndAge = 74,  MonthlyMemberPremium=55.92M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=12.58M, TotalMonthlyMemberPremium=68.50M, CompanyMemberPremium=69.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 2, AvbobPlanID = 12, MemberCover = 30000M, SpouseCover = 0M,  Child14To21YearsCover=0M,  Child6To13YearsCover=0M, Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=3500M, StartAge=65, EndAge = 74,  MonthlyMemberPremium=83.88M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=18.87M, TotalMonthlyMemberPremium=102.75M, CompanyMemberPremium=105.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },



                new AvbobPolicyPremium {AvbobAgeGroupID = 3, AvbobPlanID = 13, MemberCover = 10000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M,  StartAge=75, EndAge = 84, MonthlyMemberPremium=49.21M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=11.07M, TotalMonthlyMemberPremium=60.28M, CompanyMemberPremium=65.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 3, AvbobPlanID = 14, MemberCover = 15000M, SpouseCover = 0M,  Child14To21YearsCover=0M, Child6To13YearsCover=0M,  Child1To5YearsCover=0M,  ChildStillBornTo11MonthsCover=0M,  StartAge=75, EndAge = 84, MonthlyMemberPremium=73.82M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=16.60M, TotalMonthlyMemberPremium=90.42M, CompanyMemberPremium=95.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 3, AvbobPlanID = 15, MemberCover = 20000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M, StartAge=75, EndAge = 84,  MonthlyMemberPremium=98.43M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=22.14M, TotalMonthlyMemberPremium=120.57M, CompanyMemberPremium=125.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 3, AvbobPlanID = 16, MemberCover = 30000M, SpouseCover = 0M,  Child14To21YearsCover=0M,  Child6To13YearsCover=0M, Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=3500M, StartAge=75, EndAge = 84,  MonthlyMemberPremium=147.94M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=33.28M, TotalMonthlyMemberPremium=181.22M, CompanyMemberPremium=185.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },


                new AvbobPolicyPremium {AvbobAgeGroupID = 4, AvbobPlanID = 17, MemberCover = 10000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M,  StartAge=85, EndAge = 1000, MonthlyMemberPremium=117.24M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=26.37M, TotalMonthlyMemberPremium=143.61M, CompanyMemberPremium=150M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 4, AvbobPlanID = 18, MemberCover = 15000M, SpouseCover = 0M,  Child14To21YearsCover=0M, Child6To13YearsCover=0M,  Child1To5YearsCover=0M,  ChildStillBornTo11MonthsCover=0M,  StartAge=85, EndAge = 1000, MonthlyMemberPremium=175.86M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=39.56M, TotalMonthlyMemberPremium=215.42M, CompanyMemberPremium=220.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 4, AvbobPlanID = 19, MemberCover = 20000M, SpouseCover = 0M, Child14To21YearsCover=0M,  Child6To13YearsCover=0M,  Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=0M, StartAge=85, EndAge = 1000, MonthlyMemberPremium=234.48M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=52.78M, TotalMonthlyMemberPremium=287.23M, CompanyMemberPremium=295M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },

                new AvbobPolicyPremium {AvbobAgeGroupID = 4, AvbobPlanID = 20, MemberCover = 30000M, SpouseCover = 0M,  Child14To21YearsCover=0M,  Child6To13YearsCover=0M, Child1To5YearsCover=0M, ChildStillBornTo11MonthsCover=3500M, StartAge=85, EndAge = 1000, MonthlyMemberPremium=351.72M, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=79.13M, TotalMonthlyMemberPremium=430.85M, CompanyMemberPremium=440.00M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },


               new AvbobPolicyPremium {AvbobAgeGroupID = 5, AvbobPlanID = 21, ExtendedChildUpTo18YearsCover = 5000M, MonthlyExtendedChildRiskPremium = 5.00M,  StartAge=0, EndAge = 18, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=1.25M, TotalMonthlyMemberPremium=6.12M, CompanyMemberPremium=10M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 },


               new AvbobPolicyPremium {AvbobAgeGroupID = 5, AvbobPlanID = 22, ExtendedChildUpTo18YearsCover = 10000M, MonthlyExtendedChildRiskPremium = 10.00M,  StartAge=0, EndAge = 18, MonthlyMemberCommissionPercentage = 22.50M, MonthlyMemberCommission=2.25M, TotalMonthlyMemberPremium=12.25M, CompanyMemberPremium=15M, IsActive = true, CreateDate = DateTime.Parse( DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss")), CreateUserID = 1 }

            };


            avbobPremiums.ForEach(premium => context.AvbobPolicyPremiums.Add(premium));
            context.SaveChanges();
